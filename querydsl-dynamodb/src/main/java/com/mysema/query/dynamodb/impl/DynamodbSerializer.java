...
public class DynamodbSerializer implements
		Visitor<Object, DynamoDBScanExpression> {
	...
	private void populateScanExpression(List<Expression<?>> expressions,
			Condition condition, DynamoDBScanExpression scanExpression) {
		...
		for (Expression<?> expression : expressions) {
			...
			if (result instanceof String) {
				...
				throw new UnsupportedOperationException("Invalid result: "
						+ result);
		}
